...
func (t *SimpleChaincode) addConsent(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	mobileID = args[0]
	var consentLog = ConsentLog{MobileID: args[0], MobileNumber: args[1], AAL: args[2], MobileIDIAL: args[3], IssuerName: args[4], VerifierCode: args[5], VerifierName: args[6], ConsentDate: args[7], TxCode: args[8]}
...
// Query MobileID Consent log
func (t *SmartContract) queryConsent(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SmartContract) queryAllConsents(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	startKey := "CONSENT_0"
